...
| [0008](0008-batched-ingest-and-daily-rollups.md)   | Batched ingestion and daily rollups for large volume | 2026-07-24 | Accepted           |
| [0009](0009-secret-key-out-of-the-database.md)     | Keep SECRET_KEY out of the database it protects      | 2026-09-11 | Superseded by 0010 |
| [0010](0010-secret-key-is-environment-only.md)     | The encryption root comes from the environment only  | 2026-09-11 | Accepted           |
